...
Se vivi nell'Unione europea, la regolamentazione non è una "possibile implicazione futura": ha un nome, un numero e una scadenza. Il regolamento (UE) 2024/1689 — l'AI Act — è in vigore dall'agosto 2024 e si applica a tappe: da febbraio 2025 valgono i divieti assoluti (manipolazione subliminale, social scoring) e il principio di alfabetizzazione all'AI; da agosto 2025 gli obblighi per i modelli di uso generale, che ricadono sui *provider* — Anthropic, OpenAI, non su di te; e il **2 agosto 2026** scattano gli obblighi di trasparenza, la data che riguarda più da vicino chi gli agenti li usa. Le regole sui sistemi ad alto rischio erano previste per la stessa data, ma l'accordo "Digital Omnibus on AI" (intesa provvisoria del 6 maggio 2026, confermata dal Consiglio il 13 maggio) le ha rinviate al **2 dicembre 2027** (agosto 2028 per i prodotti regolamentati); l'obbligo di watermarking dei contenuti sintetici slitta invece al 2 dicembre 2026.
...
3. **Alto rischio.** Se l'agente entra in decisioni che incidono sulla vita delle persone — selezione del personale, accesso al credito, valutazioni — il sistema ricade nelle categorie "ad alto rischio", con obblighi pesanti: sorveglianza umana documentata, registrazione degli eventi, valutazioni di conformità. Per questi obblighi la scadenza è stata spostata al 2 dicembre 2027 (Digital Omnibus, maggio 2026), ma per una micro-impresa la risposta pratica, nove volte su dieci, resta la più semplice: non mettere l'agente lì.
...
**(!) Attenzione:** queste pagine orientano, non sostituiscono una consulenza legale. Se il tuo agente opera in un settore regolamentato (sanità, finanza, selezione del personale), parlane per tempo con un professionista: gli obblighi di trasparenza valgono già dal 2 agosto 2026, quelli sui sistemi ad alto rischio dal 2 dicembre 2027. Il testo integrale del regolamento e l'accordo Digital Omnibus sono su EUR-Lex (riferimenti in Appendice E).
...
Cambieranno i prezzi dei modelli, quasi certamente al ribasso: è la costante dell'intero settore, e significa che le tabelle di costo del Capitolo 14 vanno rilette ogni pochi mesi, di solito in meglio. Cambierà la mappa dell'ecosistema: tra le piattaforme hosted del Capitolo 21 qualcuna si fonderà o chiuderà, nasceranno wrapper e varianti nuove, e il filtro resta il test delle tre domande — licenza del codice, modello BYOK, formato dei file: se la notizia non tocca nessuna delle tre, il tuo agente domani sarà identico a oggi. Arriverà, scaglionato, l'enforcement dell'AI Act: dal 2 agosto 2026 per la trasparenza e dal 2 dicembre 2027 per i sistemi ad alto rischio, i primi casi concreti diranno quanto severa sarà l'applicazione, e conviene seguirli dalle fonti primarie più che dai titoli. E crescerà la comunicazione agente-agente: con Moltbook in mano a Meta e i meccanismi come `sessions_send` già nel framework, è plausibile che una quota crescente delle interazioni del tuo agente sia con altri agenti — il che renderà i confini del Capitolo 13 più importanti, non meno.
...
- [Digital Omnibus on AI — accordo del 6 maggio 2026](https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai) — confermato dal Consiglio il 13 maggio; rinvia gli obblighi sui sistemi ad alto rischio al 2 dicembre 2027
